  ...
  !(function () {
    for (
      ...
      (window.requestAnimationFrame = window[i[a] + "RequestAnimationFrame"]),
        (window.cancelAnimationFrame =
          window[i[a] + "CancelAnimationFrame"] ||
          window[i[a] + "CancelRequestAnimationFrame"]);
    ...
    (n.fn.sakura = function (i) {
      ...
      function t(n, i, a) {
        for (var t = 0; e > t; t++)
          o[t] || (i = i.toLowerCase()),
            n.get(0).addEventListener(o[t] + i, a, !1);
      }
      ...
      var d = function () {
        ...
        var o =
            i.blowAnimations[
              Math.floor(Math.random() * i.blowAnimations.length)
            ],
          e =
            i.swayAnimations[
              Math.floor(Math.random() * i.swayAnimations.length)
            ],
        ...
        t(u, "AnimationEnd", function () {
          ...
          t(u, "AnimationIteration", function (a) {
            -1 != n.inArray(a.animationName, i.blowAnimations) &&
              n(this).remove();
          }),
          u
            .css({
